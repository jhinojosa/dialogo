...
ALTER TABLE public.seq_acta_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.acta OWNER TO dialogo;
...
ALTER TABLE public.seq_balance_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.balance OWNER TO dialogo;
...
ALTER TABLE public.seq_correccion_movida_id OWNER TO dialogo;
...
ALTER TABLE public.correccion_movida OWNER TO dialogo;
...
ALTER TABLE public.seq_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.dialogo OWNER TO dialogo;
...
ALTER TABLE public.seq_intervencion_id OWNER TO dialogo;
...
ALTER TABLE public.intervencion OWNER TO dialogo;
...
ALTER TABLE public.seq_maestro_categoria_id OWNER TO dialogo;
...
ALTER TABLE public.maestro_categoria OWNER TO dialogo;
...
ALTER TABLE public.seq_maestro_det_cat_id OWNER TO dialogo;
...
ALTER TABLE public.maestro_det_categoria OWNER TO dialogo;
...
ALTER TABLE public.seq_maestro_movida_id OWNER TO dialogo;
...
ALTER TABLE public.maestro_movida OWNER TO dialogo;
...
ALTER TABLE public.seq_maestro_regla_id OWNER TO dialogo;
...
ALTER TABLE public.maestro_regla OWNER TO dialogo;
...
ALTER TABLE public.seq_marcador_id OWNER TO dialogo;
...
ALTER TABLE public.marcador OWNER TO dialogo;
...
ALTER TABLE public.seq_movida_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.movida_dialogo OWNER TO dialogo;
...
ALTER TABLE public.seq_nota_intervencion_id OWNER TO dialogo;
...
ALTER TABLE public.nota_intervencion OWNER TO dialogo;
...
ALTER TABLE public.seq_regla_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.regla_dialogo OWNER TO dialogo;
...
ALTER TABLE public.seq_restriccion_dialogo_id OWNER TO dialogo;
...
ALTER TABLE public.restriccion_dialogo OWNER TO dialogo;
...
ALTER TABLE public.seq_maestromovida_id OWNER TO dialogo;
...
ALTER TABLE public.usuario OWNER TO dialogo;
