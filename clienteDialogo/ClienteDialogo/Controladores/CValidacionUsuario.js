 ...
 */
CValidacionUsuario.prototype.registrar = function(fullname, username, password, archivoimagen, email, mensajeError) {
    ...
    try{
        ...
        var _reg=_cm.conexion("registrarUsuario", parametros);
