...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            bold          : { visible : true, tags : ['b', 'strong'], css : { fontWeight : 'bold' }, tooltip : "Negrita" },
            italic        : { visible : true, tags : ['i', 'em'], css : { fontStyle : 'italic' }, tooltip : "Cursiva" },
            strikeThrough : { visible : false, tags : ['s', 'strike'], css : { textDecoration : 'line-through' }, tooltip : "Tachado" },
            underline     : { visible : true, tags : ['u'], css : { textDecoration : 'underline' }, tooltip : "Subrayado" },

            separator00 : { visible : false, separator : true },

            justifyLeft   : { visible : true, css : { textAlign : 'left' }, tooltip : "Alinear a la izquierda" },
            justifyCenter : { visible : true, tags : ['center'], css : { textAlign : 'center' }, tooltip : "Centrar" },
            justifyRight  : { visible : true, css : { textAlign : 'right' }, tooltip : "Alinear a la derecha" },
            justifyFull   : { visible : false, css : { textAlign : 'justify' }, tooltip : "Justificar" },
            ...
            subscript   : { visible : false, tags : ['sub'], tooltip : "Subíndice" },
            superscript : { visible : false, tags : ['sup'], tooltip : "Superíndice" },

            separator03 : { visible : false, separator : true },

            undo : { visible : false, tooltip : "Deshacer" },
            redo : { visible : false, tooltip : "Rehacer" },

            separator04 : { visible : false, separator : true },

            insertOrderedList    : { visible : false, tags : ['ol'], tooltip : "Insertar lista ordenada" },
            insertUnorderedList  : { visible : false, tags : ['ul'], tooltip : "Insertar lista no ordenada" },
            insertHorizontalRule : { visible : false, tags : ['hr'], tooltip : "Insertar regla horizontal" },
            ...
            increaseFontSize : { visible : false && !( $.browser.msie ), tags : ['big'], tooltip : "Aumentar tamaño de fuente" },
            decreaseFontSize : { visible : false && !( $.browser.msie ), tags : ['small'], tooltip : "Reducir tamaño de fuente" },
