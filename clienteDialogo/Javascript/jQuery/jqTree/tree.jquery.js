...
/*
 *  Modificado por Cristian Chávez para la aplicación Sistema para el diálogo remoto.
 *  
 *  Línea 888: } else if ($target.is('div') || $target.is('span') || $target.is('input') || $target.is('button')) {
 *  original: } else if ($target.is('div') || $target.is('span')) {
 *  
 */
  ...
  */
  ...
  JqTreeWidget = (function(_super) {
    ...
    JqTreeWidget.prototype._click = function(e) {
      ...
      } else if ($target.is('div') || $target.is('span') || $target.is('input') || $target.is('button')) {
